...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String> {
    ...
    private static final int GITHUB_SEARCH_LOADER_ID = 22;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //this deliver the already fetched Github results, if any
    ...
    private void makeGithubSearchQuery() {
        ...
        if (githubQuery.isEmpty()) {
            Toast.makeText(this, "No search query entered", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        if (githubSearchLoader == null) {
            loaderManager.initLoader(GITHUB_SEARCH_LOADER_ID, args, this);
        } else {
            loaderManager.restartLoader(GITHUB_SEARCH_LOADER_ID, args, this);
        }
    }
    ...
    public Loader<String> onCreateLoader(int id, @Nullable final Bundle args) {
        return new AsyncTaskLoader<String>(this) {
            ...
            public String loadInBackground() {
                String url = args != null ? args.getString(SEARCH_QUERY_URL_EXTRA) : null;
