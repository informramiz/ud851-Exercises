...
public class MainActivity extends AppCompatActivity implements TaskAdapter.ItemClickListener {
    ...
    private void retrieveTasks() {
        ...
        //live data runs on background thread
        final LiveData<List<TaskEntry>> tasksLiveData = mDb.taskDao().loadAllTasks();
        tasksLiveData.observe(this, new Observer<List<TaskEntry>>() {
            @Override
            public void onChanged(@Nullable List<TaskEntry> taskEntries) {
                Log.d(TAG, "Tasks changed, retrieved new tasks");
                //onChange method is called on UI thread so we can
                //access views from this method
