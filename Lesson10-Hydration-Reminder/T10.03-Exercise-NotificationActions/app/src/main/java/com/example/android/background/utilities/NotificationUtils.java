...
public class NotificationUtils {
    ...
    private static final int IGNORE_WATER_REMINDER_PENDING_INTENT_ID = 3418;
    private static final int DRINK_WATER_ACTION_PENDING_INTENT = 3419;
    /**
    ...
    private static NotificationCompat.Action ignoreReminderAction(Context context) {
        ...
        ignoreReminderIntent.setAction(ReminderTasks.ACTION_DISMISS_NOTIFICATOIN);
        PendingIntent ignoreReminderPendingIntent = PendingIntent.getService(
                context,
                IGNORE_WATER_REMINDER_PENDING_INTENT_ID,
        ...
        NotificationCompat.Action ignoreReminderAction = new NotificationCompat.Action(
                ...
                context.getString(R.string.title_action_ignore_reminder),
    ...
    private static NotificationCompat.Action drinkWaterAction(Context context) {
        ...
        PendingIntent drinkWaterPendingIntent = PendingIntent.getService(
                context,
                DRINK_WATER_ACTION_PENDING_INTENT,
                drinkWaterIntent,
                PendingIntent.FLAG_UPDATE_CURRENT
        );
        ...
        NotificationCompat.Action drinkWaterAction = new NotificationCompat.Action(
                ...
                context.getString(R.string.title_action_drink_water),
