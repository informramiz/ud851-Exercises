...
public class ReminderTasks {
    ...
    public static final String ACTION_REMINDER_WHEN_CHARGING = "remind-when-charging";
    ...
    public static void executeTask(Context context, String action) {
        ...
        } else if (ACTION_REMINDER_WHEN_CHARGING.equals(action)) {
            reminderUserWhenCharging(context);
        }
    }
    ...
    private static void reminderUserWhenCharging(Context context) {
