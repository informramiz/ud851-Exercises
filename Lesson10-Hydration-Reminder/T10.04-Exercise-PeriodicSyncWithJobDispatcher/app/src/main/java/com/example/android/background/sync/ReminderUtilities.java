...
public class ReminderUtilities {
    ...
    private static final int REMINDER_INTERVAL_SECONDS = (int)TimeUnit.SECONDS.toSeconds(REMINDER_INTERVAL_MINUTES);
    private static final int SYNC_FLEXTIME_SECONDS = REMINDER_INTERVAL_SECONDS;
    private static final String REMINDER_JOB_TAG = "hydration_reminder_job_tag";
    ...
    synchronized public static void scheduleDrinkWhenChargingReminder(Context context) {
