...
public class MainActivity extends AppCompatActivity implements
    ...
    private boolean isDeviceCharging() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            IntentFilter batteryStickyIntentFilter = new IntentFilter(Intent.ACTION_BATTERY_CHANGED);
            Intent batteryStatusIntent = registerReceiver(null, batteryStickyIntentFilter);
